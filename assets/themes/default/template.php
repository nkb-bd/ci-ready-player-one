...
<head>
  ...
  <link rel="icon" type="image/png" href="<?php echo base_url("/{$this->settings->themes_folder}/{$this->settings->theme}/")?>img/favicon.png">
  ...
  <!-- CSS Files -->
  <link href="<?php echo base_url("/{$this->settings->themes_folder}/{$this->settings->theme}/")?>css/material-kit.css?v=2.0.5" rel="stylesheet" />
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.7.0/animate.min.css" />
  <!-- CSS Just for demo purpose, don't include it in your project -->
  <link href="<?php echo base_url("/{$this->settings->themes_folder}/{$this->settings->theme}/")?>demo/demo.css" rel="stylesheet" />
  <script src="<?php echo base_url("/{$this->settings->themes_folder}/{$this->settings->theme}/")?>js/core/jquery.min.js" type="text/javascript"></script>
...
<body class="index-page sidebar-collapse">
    ...
    <div class="container">
      ...
      <div class="copyright float-right">
        ...
        <script>
         ...
         <a href="http://thedigitalavengers.com">
             Digital Avengers
            </a>
      </div>
    </div>
  ...
  <script src="<?php echo base_url("/{$this->settings->themes_folder}/{$this->settings->theme}/")?>js/plugins/bootstrap-datetimepicker.js" type="text/javascript"></script>
  <!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
  <script src="<?php echo base_url("/{$this->settings->themes_folder}/{$this->settings->theme}/")?>js/plugins/nouislider.min.js" type="text/javascript"></script>
  <!--  Google Maps Plugin    -->
  <script src="https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script>
  <!-- Control Center for Material Kit: parallax effects, scripts for the example pages etc -->
  <script src="<?php echo base_url("/{$this->settings->themes_folder}/{$this->settings->theme}/")?>js/material-kit.js?v=2.0.5" type="text/javascript"></script>
