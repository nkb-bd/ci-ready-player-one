  <div class="page-header header-filter" data-parallax="true" style="background-image: url('<?php echo base_url("/{$slider_data[0]['path']}")?>'); background-position: top center;">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
                    ...
                    <div class="info">
                      <div class="icon icon-info">
                        <?php if (!empty($data['path'])): ?>
                           <img src="<?=base_url()?><?=$data['path']?>" alt="T<?=$data['heading']?>" class="img-raised img-fluid">
                        <?php endif ?>
                      </div>
                      <h4 class="info-title"><?=$data['heading']?></h4>
