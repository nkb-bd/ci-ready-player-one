        ...
        <thead>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php if ($sort == 'name') : ?><span class="fa fa-arrow-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif; ?>
                </td>
                <td>
                    ...
                    <?php if ($sort == 'email') : ?><span class="fa fa-arrow-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif; ?>
                </td>
                <td>
                    ...
                    <?php if ($sort == 'title') : ?><span class="fa fa-arrow-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif; ?>
                </td>
                <td>
                    ...
                    <?php if ($sort == 'created') : ?><span class="fa fa-arrow-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif; ?>
                </td>
                <td class="pull-right">
            ...
            <tr>
                <?php echo form_open("{$this_url}?sort={$sort}&dir={$dir}&limit={$limit}&offset=0{$filter}", array('role'=>'form', 'id'=>"filters")); ?>
                    ...
                    <th<?php echo ((isset($filters['created'])) ? ' class="has-success"' : ''); ?>>
                        <div class="input-group date" styledata-date="<?php echo date('m-d-Y'); ?>" data-date-format="mm-dd-yyyy" style="margin-bottom: 0px;">
                    ...
                    <th>
                        <div class="text-right">
                            <a href="<?php echo $this_url; ?>" class="btn btn-danger btn-sm"><span class="fa fa-refresh"></span> <?php echo lang('core button reset'); ?></a>
                            <button type="submit" name="submit" value="<?php echo lang('core button filter'); ?>" class="btn btn-success btn-sm"><span class="fa fa-filter"></span> <?php echo lang('core button filter'); ?></button>
                        </div>
                    </th>
                <?php echo form_close(); ?>
            </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="text-right">
                                <div class="btn-group">
                                    <?php if ($message['read']) : ?>
                                        <a href="#modal-<?php echo $message['id']; ?>" data-toggle="modal" data-read="true" class="btn btn-default btn-xs" title="<?php echo lang('contact button read'); ?>"><span class="fa fa-envelope"></span></a>
                                    <?php else : ?>
                                        <a href="#modal-<?php echo $message['id']; ?>" data-toggle="modal" data-read="false" class="btn  btn-primary  btn-xs" title="<?php echo lang('contact button read'); ?>"><span class="fa fa-envelope"></span></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </td>
    ...
    <div class="panel-footer">
        <div class="row">
            ...
            <div class="col-md-2 text-right">
                <?php if ($total) : ?>
                    <a href="<?php echo $this_url; ?>/export?sort=<?php echo $sort; ?>&dir=<?php echo $dir; ?><?php echo $filter; ?>" class="btn btn-success btn-sm"><span class="fa fa-export"></span> <?php echo lang('admin button csv_export'); ?></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
